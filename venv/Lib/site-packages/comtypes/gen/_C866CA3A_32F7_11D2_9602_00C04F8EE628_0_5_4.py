...
__all__ = [
    'DISPID_SLWWord', 'DISPID_SPIGrammarId', 'SAFTGSM610_44kHzMono',
    'ISpPhoneticAlphabetSelection', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPCLangId', 'DISPID_SGRSTsItem', 'SP_VISEME_14', 'SVP_4',
    'SPFILEMODE', 'ISpeechRecoResultTimes', 'ISpObjectWithToken',
    'ISpPhoneConverter', 'SAFT12kHz8BitMono', 'SECFDefault',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SLWType',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRGState',
    'DISPID_SpeechAudioFormat', 'SGSExclusive', 'DISPID_SPPParent',
    'SPRECORESULTTIMES', 'SPFM_OPEN_READWRITE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpEventSource',
    'DISPID_SASFreeBufferSpace', 'DISPID_SpeechVoiceEvent',
    'ISpRecoGrammar2', 'SINoSignal',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SGRSRule',
    'DISPID_SGRSTText', 'SPCT_SLEEP', 'DISPID_SVSVisemeId',
    'SPSHORTCUTPAIR', 'DISPID_SpeechLexiconWord',
    'DISPID_SRGetPropertyString', 'SSTTDictation',
    'SAFT11kHz8BitStereo', 'DISPID_SRGSetTextSelection',
    'SECHighConfidence', 'DISPID_SDKGetStringValue',
    'SPRST_ACTIVE_ALWAYS', 'SPEI_SR_AUDIO_LEVEL',
    'SpeechTokenIdUserLexicon', 'SVESentenceBoundary',
    'SSTTTextBuffer', 'SPCT_DICTATION', 'ISpMMSysAudio',
    'SGDSActiveWithAutoPause', 'Speech_Max_Pron_Length',
    'DISPID_SGRAddResource', 'SVP_5', 'SDTAudio', 'DISPID_SRRAudio',
    'SDA_No_Trailing_Space', 'DISPID_SRCRetainedAudio',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SpeechPhraseRule', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SWFEChannels', 'SDTAll', 'SpeechAudioProperties',
    'ISpeechCustomStream', 'DISPID_SRCBookmark', 'STCAll',
    'SPXMLRESULTOPTIONS', 'DISPID_SRAudioInputStream',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SDKSetLongValue',
    'SPAR_Medium', 'DISPID_SLPSymbolic', 'SpLexicon', 'SP_VISEME_5',
    'eLEXTYPE_PRIVATE7', 'SPPHRASEELEMENT', 'DISPID_SRCEHypothesis',
    'DISPID_SLGetPronunciations', 'DISPID_SMSSetData',
    'DISPID_SRCEventInterests', 'SRADefaultToActive', 'SRTReSent',
    'SVSFDefault', 'eLEXTYPE_RESERVED7',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpeechUserTraining',
    'SSFMOpenForRead', 'DISPID_SVEAudioLevel', 'DISPID_SpeechLexicon',
    'DISPID_SVSLastStreamNumberQueued', 'ISpeechLexicon',
    'SAFT12kHz16BitMono', 'SPBO_PAUSE', 'DISPID_SLWsItem',
    'ISpeechAudioFormat', 'ISpeechRecoResult',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRCEBookmark',
    'SPSSuppressWord', 'DISPID_SpeechPhraseAlternate', 'SP_VISEME_19',
    'SPSEMANTICERRORINFO', 'DISPID_SPPEngineConfidence',
    'ISpeechObjectToken', 'DISPID_SVEViseme', 'ISpeechGrammarRules',
    'DISPID_SVGetProfiles', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPIAudioSizeBytes', 'SpeechRunState',
    'DISPID_SPERetainedSizeBytes', 'SP_VISEME_9',
    ...
    'DISPID_SRSSupportedLanguages', 'STSF_LocalAppData', 'SPXRO_SML',
    'SPAR_Unknown', 'SpeechTokenShellFolder', 'DISPID_SDKOpenKey',
    'DISPID_SPPs_NewEnum', 'SREStreamStart', 'DISPID_SAFGuid',
    'DISPID_SRCCreateGrammar', 'eLEXTYPE_RESERVED6',
    'DISPID_SpeechVoice', 'eLEXTYPE_USER', '_RemotableHandle',
    'SPDKL_CurrentUser', 'SVP_2', 'SINoise', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SpeechDataKey', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SpeechPhoneConverter', 'DISPID_SASCurrentSeekPosition',
    'eLEXTYPE_PRIVATE11', 'SP_VISEME_1', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPRNumberOfElements', 'SpeechTokenKeyFiles', 'SRAExport',
    'SPVOICESTATUS', 'SPWORDPRONOUNCEABLE', 'DISPID_SLWLangId',
    'DISPID_SOTCSetId', 'ISpeechPhraseProperty',
    'DISPID_SRRRecoContext', 'STSF_CommonAppData', 'SPWT_DISPLAY',
    'DISPID_SRRAlternates', 'eLEXTYPE_VENDORLEXICON', 'SFTInput',
    'SpCustomStream', 'SAFT24kHz8BitStereo', 'SpeechStreamFileMode',
    'tagSPTEXTSELECTIONINFO', 'ISpResourceManager',
    'SPRST_NUM_STATES', 'SPINTERFERENCE_NONE', 'SpeechAudioVolume',
    'DISPID_SABIEventBias',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechPhoneConverter', 'DISPID_SPAs_NewEnum', 'SFTSREngine',
    'DISPID_SVResume', 'SpeechMicTraining', 'SPSERIALIZEDPHRASE',
    'SAFTADPCM_11kHzMono', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SABufferNotifySize', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SGRSTNextState', 'SAFT48kHz16BitMono', 'DISPID_SPACommit',
    'SPPHRASEPROPERTY', 'SPCS_DISABLED', 'DISPID_SLWs_NewEnum',
    'SPLEXICONTYPE', 'ISpRecognizer3', 'DISPID_SFSClose', 'SWTAdded',
    'SAFTNoAssignedFormat', 'ISpeechPhraseReplacements',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SLPs_NewEnum',
    'DISPID_SRGSetWordSequenceData', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SRGDictationSetState',
    'SPPS_Noun', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SMSGetData', 'SDKLLocalMachine',
    'DISPID_SRCRequestedUIType', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SASetState', 'ISpeechPhraseAlternates',
    'SpeechStreamSeekPositionType', 'SpeechCategoryVoices',
    'SPGS_ENABLED', 'SPSERIALIZEDRESULT', 'DISPID_SMSADeviceId',
    'ISpeechGrammarRuleStateTransitions', 'SPINTERFERENCE',
    'SVSFParseSapi', 'SGRSTTEpsilon', 'DISPID_SRCERecognition',
    'ISpeechPhraseRules', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SDKDeleteValue', 'SpeechRecognitionType',
    'ISpeechXMLRecoResult', 'SPWORDPRONUNCIATION',
    'Speech_StreamPos_Asap', 'SVEBookmark', 'DISPID_SVSPhonemeId',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SVVoice',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SGRAttributes',
    'DISPID_SPEsItem', 'DISPID_SRCAudioInInterferenceStatus',
    'SRSInactiveWithPurge', 'SPAO_NONE', 'SRCS_Enabled',
    'DISPID_SRCVoicePurgeEvent', 'SpeechTokenKeyAttributes', 'SPWORD',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPARecoResult', 'SpeechAllElements', 'ISpeechMMSysAudio',
    'SVSFParseSsml', 'SPFM_OPEN_READONLY', 'SITooQuiet',
    'SpeechVisemeFeature', 'SPAUDIOSTATUS',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SREAdaptation',
    'SREPropertyNumChange', 'SPPHRASERULE', 'SVSFUnusedFlags',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechLexiconWords',
    'SPRULE', 'DISPID_SpeechPhraseProperties', 'DISPID_SPRuleId',
    'SVEAllEvents', 'SRSEDone', 'DISPID_SpeechPhraseRules',
    'SAFT12kHz8BitStereo', 'DISPID_SGRSTransitions',
    '__MIDL_IWinTypes_0009', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SGRId', 'SECNormalConfidence', 'SGSEnabled',
    'DISPID_SVSkip', 'DISPID_SPPFirstElement', 'DISPID_SRRTLength',
    'SVP_20', 'SLOStatic', 'SPEI_RECO_STATE_CHANGE', 'SLODynamic',
    'DISPID_SRGReset', 'SRSEIsSpeaking', 'SVEPrivate',
    'DISPID_SAFType', 'DISPID_SRRSaveToMemory',
    'DISPID_SLWPronunciations', 'SpNullPhoneConverter',
    'DISPID_SVSRunningState', 'UINT_PTR',
    'DISPID_SREmulateRecognition', 'DISPID_SPIReplacements',
    'DISPIDSPRG', 'DISPID_SpeechAudioStatus', 'SPRS_INACTIVE',
    'DISPID_SRCESoundStart', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SPISaveToMemory', 'STCInprocServer', 'DISPID_SRGCommit',
    'SPAR_Low', 'SREPropertyStringChange', 'SDTReplacement',
    'SpeechLexiconType', 'SGDSInactive', 'SECFIgnoreCase',
    'DISPIDSPTSI_ActiveOffset', 'SVSFVoiceMask',
    'SAFT48kHz8BitStereo', 'SVEPhoneme', 'DISPID_SPELexicalForm',
    'SpeechAddRemoveWord', 'DISPID_SpeechBaseStream', 'SVP_12',
    'DISPID_SRCCmdMaxAlternates', 'SAFT8kHz16BitStereo',
    'SAFTCCITT_uLaw_44kHzMono', 'SDTRule', 'SAFTCCITT_uLaw_11kHzMono',
    'SP_VISEME_11', 'SPEI_RESERVED5', 'SpeechWordType', 'SGLexical',
    'ISpeechGrammarRule', 'SVPOver', 'SPVPRI_OVER', 'SPAS_STOP',
    'ISpeechPhraseElements', 'DISPID_SVSInputSentencePosition',
    'SpeechGrammarTagDictation', 'SDTProperty', 'SVSFNLPMask',
    'DISPID_SGRSAddWordTransition', 'SPWAVEFORMATTYPE',
    'SpeechRegistryUserRoot', 'SPRECOSTATE',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFTExtendedAudioFormat',
    'SVP_7', 'SSFMOpenReadWrite', 'SAFTADPCM_11kHzStereo',
    'SGRSTTWildcard', 'SRAInterpreter', 'tagSTATSTG',
    'SpeechDataKeyLocation', 'DISPID_SRSNumberOfActiveRules',
    'SPGRAMMARSTATE', 'DISPID_SRRPhraseInfo', 'SSFMCreateForWrite',
    'SGSDisabled', 'SPDKL_CurrentConfig',
    'SpeechCategoryPhoneConverters', '_ISpeechRecoContextEvents',
    'SPGS_EXCLUSIVE', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SWFEBitsPerSample', 'DISPID_SPRs_NewEnum',
    'SPPARTOFSPEECH', 'SpeechAudioFormatType',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SDKSetBinaryValue', 'SPWF_INPUT',
    'DISPID_SRIsShared', 'DISPID_SRRGetXMLErrorInfo',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SLPPhoneIds',
    'SRESoundStart', 'ISpNotifySink', 'ISpNotifyTranslator',
    'DISPID_SVStatus', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SpeechPhraseElement', 'ISpeechObjectTokenCategory',
    'DISPID_SVSpeakStream', 'DISPID_SPRuleConfidence',
    'DISPID_SLPType', 'ISpeechDataKey', 'DISPID_SGRSTWeight',
    'SPSVerb', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SGRsCount', 'SPINTERFERENCE_TOOFAST', 'SPEI_MIN_SR',
    'ISpeechVoice', 'SpeechRetainedAudioOptions', 'SPBO_TIME_UNITS',
    'SP_VISEME_0', 'ISpLexicon', 'ISpeechResourceLoader', 'SVP_1',
    'ISpeechRecognizer', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SINone', 'SpStreamFormatConverter', 'SASPause', 'SPEI_RESERVED2',
    'SPPS_RESERVED3', 'SRTExtendableParse',
    'SDA_Consume_Leading_Spaces', 'SPEI_RECOGNITION', 'SPSFunction',
    'SpeechRuleState', 'eLEXTYPE_PRIVATE9', 'SAFTGSM610_22kHzMono',
    'DISPID_SPIElements', 'SRTSMLTimeout', 'DISPID_SPPId',
    'DISPID_SRCEStartStream', 'DISPID_SRCEInterference',
    'SpSharedRecoContext', 'DISPID_SAStatus',
    'SPEI_RECO_OTHER_CONTEXT', 'SPWT_PRONUNCIATION',
    'DISPID_SWFEFormatTag', 'SVP_13', 'SPEVENTENUM',
    'ISpeechLexiconPronunciation', 'SpMMAudioOut', 'SPEI_SR_PRIVATE',
    'DISPID_SVSLastBookmark', 'DISPID_SRStatus',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SVAlertBoundary',
    'SpeechBookmarkOptions', 'SPSInterjection', 'SVP_18',
    'SPRECOCONTEXTSTATUS', 'DISPID_SpeechRecoResult2',
    'DISPID_SRSetPropertyNumber', 'DISPID_SOTCDefault',
    'SVF_Emphasis', 'SPSHT_OTHER', 'SVP_9', 'SVP_3',
    'DISPID_SpeechAudioBufferInfo', 'SPPHRASE', 'SpAudioFormat',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SOTGetDescription',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpeechTokenContext',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SOTGetStorageFileName',
    'ISpeechObjectTokens', 'DISPID_SPEPronunciation',
    'SpeechInterference', 'ISpObjectTokenCategory', 'DISPID_SPRText',
    'DISPID_SRGId', 'SPBOOKMARKOPTIONS', 'DISPID_SGRSTRule',
    'SECLowConfidence', 'SPEI_ADAPTATION', 'ISpStreamFormatConverter',
    'DISPID_SGRsCommitAndSave', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPPChildren', 'DISPID_SpeechPhraseProperty', 'SASRun',
    'IInternetSecurityMgrSite', 'SGDSActiveUserDelimited',
    'SP_VISEME_4', 'DISPID_SLGetWords', 'SAFT44kHz16BitStereo',
    'SPGRAMMARWORDTYPE', 'SP_VISEME_10', 'ISpeechPhraseRule',
    'SGDSActive', 'SGRSTTRule', 'SpeechRuleAttributes',
    'SPINTERFERENCE_TOOSLOW', 'SRSActive', 'DISPID_SRRGetXMLResult',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SVPause',
    'ISpeechRecoResultDispatch', 'SGLexicalNoSpecialChars',
    'DISPID_SWFEExtraData', 'SPSNoun', 'DISPID_SPERequiredConfidence',
    'SPGS_DISABLED', 'SpObjectTokenCategory', 'DISPID_SOTSetId',
    'SPSUnknown', 'SBOPause', 'DISPID_SRCSetAdaptationData',
    'DISPID_SAVolume', 'DISPID_SPPNumberOfElements',
    'DISPID_SOTDataKey', 'DISPID_SASNonBlockingIO',
    'SAFT32kHz16BitStereo', 'DISPID_SRRTimes',
    'DISPID_SPRFirstElement', 'SPVPRI_NORMAL', 'SpeechLoadOption',
    'SP_VISEME_21', 'DISPID_SGRSTType', 'DISPID_SMSAMMHandle',
    'ISpObjectToken',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SLGetGenerationChange', 'SAFT22kHz8BitMono',
    'SpeechDiscardType', 'DISPID_SPAStartElementInResult',
    'DISPID_SRSClsidEngine', 'eLEXTYPE_PRIVATE15', 'SPVPRIORITY',
    'SAFT44kHz8BitStereo', 'ISpeechPhraseAlternate',
    'ISpeechGrammarRuleState', 'DISPID_SRCState', 'SPLO_STATIC',
    'SRARoot', 'DISPID_SRGetPropertyNumber', 'SPAS_PAUSE',
    'ISpeechAudio', 'DISPID_SRRTOffsetFromStart',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SPRules_NewEnum',
    'SPPHRASEREPLACEMENT', 'SPPS_SuppressWord', 'DISPID_SRState',
    'SPEI_SENTENCE_BOUNDARY', 'SDTLexicalForm', 'DISPID_SPRuleName',
    'DISPID_SVVolume', 'SpeechFormatType', 'SAFT12kHz16BitStereo',
    'DISPID_SpeechAudio', 'SpMemoryStream', 'DISPID_SpeechMMSysAudio',
    'DISPID_SVEBookmark', 'DISPID_SRCEAdaptation', 'SWTDeleted',
    'SPWT_LEXICAL', 'DISPID_SpeechRecoContextEvents',
    'SpNotifyTranslator', 'DISPID_SGRAddState',
    'DISPID_SPEEngineConfidence', 'SPPS_Unknown', 'DISPID_SPAsCount',
    'DISPID_SRGetFormat', 'DISPID_SGRsItem', 'SpWaveFormatEx',
    'DISPID_SRGRecoContext', 'SVPNormal', 'DISPID_SVWaitUntilDone',
    'IEnumSpObjectTokens', 'DISPID_SRCEEndStream', 'DISPID_SGRName',
    'SPEI_TTS_PRIVATE', 'DISPID_SVGetVoices', 'SRERecognition',
    'DISPID_SpeechLexiconProns', 'SPPROPERTYINFO', 'SP_VISEME_2',
    'SDKLDefaultLocation', 'SpeechAudioFormatGUIDWave',
    'DISPID_SVSLastBookmarkId', 'DISPID_SLPsItem',
    'DISPID_SRDisplayUI', 'SAFTCCITT_ALaw_44kHzMono',
    'SPDATAKEYLOCATION', 'DISPID_SpeechPhraseInfo', 'SVP_11',
    'SP_VISEME_16', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SAFGetWaveFormatEx', 'SPEI_PHONEME', 'SRCS_Disabled',
    'SPBO_AHEAD', 'DISPID_SpeechRecoContext', 'SP_VISEME_18',
    'SPCT_COMMAND', 'Speech_Default_Weight', 'SGRSTTWord', 'LONG_PTR',
    'DISPIDSPTSI', 'SGDisplay', 'ISpeechAudioBufferInfo',
    'SVEWordBoundary', 'DISPID_SPCIdToPhone', 'SRSInactive',
    'DISPID_SRCEAudioLevel', 'DISPID_SpeechRecognizer',
    'SPEI_MAX_TTS', 'DISPID_SVEVoiceChange', 'SpeechEngineProperties',
    'DISPID_SpeechRecoResult', 'SECFNoSpecialChars',
    'eLEXTYPE_MORPHOLOGY', 'SpMMAudioEnum', 'SPFM_CREATE_ALWAYS',
    'DISPID_SRCEPhraseStart', 'SPAUDIOSTATE', 'STSF_AppData',
    'SVPAlert', 'SAFT8kHz8BitStereo', 'SPEI_TTS_BOOKMARK',
    'SPPS_Modifier', 'DISPID_SPRsItem', 'DISPID_SpeechObjectTokens',
    'SPEI_RESERVED6', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPRuleFirstElement', 'SpeechGrammarTagWildcard',
    'SpPhoneConverter', 'DISPID_SDKEnumKeys',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpeechBaseStream',
    'ISpRecoCategory', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SPIProperties', 'SRSActiveAlways', 'SPCONTEXTSTATE',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRCreateRecoContext',
    'DISPID_SGRSAddSpecialTransition', 'SDTDisplayText',
    'SPPS_RESERVED2', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SPIAudioStreamPosition', 'ISpeechLexiconWord',
    'SAFTGSM610_8kHzMono', 'SVP_6', 'SAFT32kHz8BitStereo',
    'SpeechPartOfSpeech', 'DISPID_SOTGetAttribute',
    'SAFT24kHz16BitMono', 'SAFTADPCM_22kHzStereo', 'SpStream',
    'DISPID_SPIEngineId', 'SVF_Stressed', 'SpInProcRecoContext',
    'DISPID_SVPriority', 'DISPID_SPEDisplayText', 'SPPS_RESERVED1',
    'SRESoundEnd', 'SPEI_WORD_BOUNDARY', 'SGRSTTTextBuffer',
    'SPCT_SUB_DICTATION', 'DISPID_SRCVoice', 'SAFT11kHz16BitStereo',
    'IInternetSecurityManager', 'SPPS_NotOverriden', 'SPSHT_EMAIL',
    'DISPID_SRGCmdSetRuleIdState', 'SPEI_HYPOTHESIS', 'SRTAutopause',
    'ISpeechVoiceStatus', 'DISPID_SPPName', 'SECFEmulateResult',
    'ISpeechRecoResult2', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SVEVoiceChange', 'SPEI_UNDEFINED',
    'ISpeechTextSelectionInformation', 'SAFT24kHz8BitMono',
    'SDKLCurrentConfig', 'SAFT32kHz8BitMono', 'SLTUser',
    'SPRST_INACTIVE', 'SpFileStream', 'eLEXTYPE_LETTERTOSOUND',
    'SPDKL_DefaultLocation', 'DISPID_SOTDisplayUI',
    'SPRECOGNIZERSTATUS', 'SpeechAudioState', 'DISPID_SRProfile',
    'SVSFNLPSpeakPunc', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SOTCategory', 'DISPID_SVEStreamStart',
    'ISpeechFileStream', 'SAFTNonStandardFormat',
    'SAFTADPCM_44kHzStereo', 'ISpXMLRecoResult',
    'SpeechRecoContextState', 'DISPID_SDKSetStringValue',
    'SPEI_START_INPUT_STREAM', 'SAFT22kHz16BitMono',
    'DISPID_SpeechXMLRecoResult', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVAudioOutput', 'SVSFParseAutodetect',
    'SSSPTRelativeToCurrentPosition', 'ISpRecoContext2',
    'eLEXTYPE_RESERVED10', 'SPINTERFERENCE_TOOQUIET',
    'SPEVENTSOURCEINFO', 'SREPhraseStart', 'DISPID_SRSAudioStatus',
    'DISPID_SPIEnginePrivateData', 'SpeechDictationTopicSpelling',
    'ISpeechRecoContext', 'SpeechWordPronounceable',
    'eLEXTYPE_PRIVATE12', 'SRTEmulated', 'DISPID_SVEWord',
    'DISPID_SpeechLexiconPronunciation', 'SAFT48kHz8BitMono',
    'eLEXTYPE_PRIVATE6', 'SREFalseRecognition', 'DISPID_SVEStreamEnd',
    'SAFT44kHz16BitMono', 'SPEI_MAX_SR', 'DISPID_SPPsItem', 'SVP_0',
    'ISpAudio', 'DISPID_SAEventHandle', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRGDictationUnload', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SGPronounciation', 'SpeechVisemeType', 'DISPID_SABIBufferSize',
    'ISpPhrase', 'DISPID_SVSLastResult', 'SpeechGrammarWordType',
    'SPSHORTCUTPAIRLIST', 'ISpDataKey', 'SAFT8kHz16BitMono',
    'SpeechVoiceSpeakFlags', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRCRetainedAudioFormat', 'SVF_None',
    'DISPID_SpeechGrammarRule', 'DISPID_SPRulesItem',
    'DISPID_SLGenerationId', 'WAVEFORMATEX', 'SPEI_PHRASE_START',
    'STCRemoteServer', 'SVSFPersistXML', 'SPDKL_LocalMachine',
    'DISPID_SRRSetTextFeedback', 'SAFTCCITT_uLaw_44kHzStereo',
    'SP_VISEME_8', 'SpeechCategoryRecoProfiles', 'SPAUDIOOPTIONS',
    'STSF_FlagCreate', 'SpeechEngineConfidence', 'SVEEndInputStream',
    'SREStateChange', 'SRERecoOtherContext', 'SRAImport',
    'ISpEventSink', 'DISPID_SPRsCount', 'SVSFParseMask',
    'ISpeechRecognizerStatus', 'DISPID_SDKGetBinaryValue',
    'SPRS_ACTIVE_USER_DELIMITED',
    'SpeechPropertyComplexResponseSpeed', 'eLEXTYPE_PRIVATE19',
    'DISPID_SOTCreateInstance', 'SP_VISEME_3', 'SPSHORTCUTTYPE',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRIsUISupported', 'SLTApp',
    'SAFT22kHz8BitStereo', 'SPAR_High', 'SREAllEvents',
    'SpeechTokenKeyUI', 'eLEXTYPE_RESERVED9', 'eLEXTYPE_PRIVATE4',
    'DISPID_SRRSpeakAudio', 'eLEXTYPE_APP', 'SPXRO_Alternates_SML',
    'SAFT22kHz16BitStereo', '_ISpeechVoiceEvents',
    'DISPID_SGRSTPropertyName', 'SPLOADOPTIONS', 'SREBookmark',
    'eLEXTYPE_PRIVATE17', 'IEnumString', 'DISPID_SRGDictationLoad',
    'ISpRecoGrammar', 'SpeechGrammarRuleStateTransitionType',
    'SREHypothesis', 'DISPID_SOTsItem', 'DISPID_SABufferInfo',
    'SPEI_REQUEST_UI', 'DISPID_SRCPause', 'ISpShortcut',
    'SPRULESTATE', 'DISPID_SRSCurrentStreamNumber', 'DISPID_SOTId',
    'DISPID_SRGCmdLoadFromFile', 'SPAS_RUN', 'eLEXTYPE_RESERVED8',
    'SAFTCCITT_ALaw_22kHzMono', 'SP_VISEME_15', 'ISpeechRecoGrammar',
    'SPAS_CLOSED', 'DISPID_SPCPhoneToId', 'SAFTADPCM_8kHzMono',
    'SPEI_SR_BOOKMARK', 'SVP_16', 'DISPID_SpeechGrammarRules',
    'SVEAudioLevel', 'SPBINARYGRAMMAR', 'DISPID_SPEDisplayAttributes',
    'SP_VISEME_13', 'DISPID_SLRemovePronunciation',
    'SpUnCompressedLexicon', 'SPSEMANTICFORMAT', 'SPPS_RESERVED4',
    'DISPID_SLWsCount', 'DISPID_SGRs_NewEnum',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRCEEnginePrivate',
    'SpPhoneticAlphabetConverter', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SDKGetlongValue', 'SSTTWildcard', 'SPEI_END_SR_STREAM',
    'SpeechCategoryAudioOut', 'ISpVoice', 'DISPID_SPEsCount',
    'SPLO_DYNAMIC', 'DISPID_SPILanguageId', 'DISPID_SWFEBlockAlign',
    'SDTPronunciation', 'SPINTERFERENCE_TOOLOUD', 'SPCATEGORYTYPE',
    'SREAudioLevel', 'SAFT16kHz16BitMono', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SVEEnginePrivate', 'SDTAlternates', 'DISPID_SPIStartTime',
    'DISPID_SGRsDynamic', 'SITooSlow', 'DISPID_SPPValue', 'SVP_14',
    'SPFM_NUM_MODES', 'SRATopLevel', 'ISpeechPhraseElement',
    'SPPS_Noncontent', 'SpTextSelectionInformation',
    'ISpeechLexiconWords', 'DISPIDSPTSI_ActiveLength',
    'SPTEXTSELECTIONINFO', 'DISPID_SRCResume', 'SBONone',
    'DISPID_SBSRead', 'SPBO_NONE', 'DISPID_SGRSAddRuleTransition',
    'ISpSerializeState', 'DISPID_SVSInputSentenceLength',
    'DISPID_SBSWrite', 'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SGRsFindRule',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPAO_RETAIN_AUDIO',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRRTStreamTime',
    'SpeechCategoryAudioIn', 'SpeechAudioFormatGUIDText',
    'DISPID_SOTRemove', 'STCInprocHandler', 'SPFM_CREATE',
    'eLEXTYPE_PRIVATE5', 'SVP_17', 'SPPS_LMA',
    'DISPID_SpeechFileStream', 'SSSPTRelativeToEnd',
    'DISPID_SPAsItem', 'SPAUDIOBUFFERINFO',
    'DISPID_SpeechWaveFormatEx', 'ISpeechMemoryStream',
    'SPVPRI_ALERT', 'SWPUnknownWordUnpronounceable',
    'DISPID_SOTCGetDataKey', 'ISpeechAudioStatus',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SADefaultFormat',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRCRecognizer',
    'ISpPhraseAlt', 'SPWORDPRONUNCIATIONLIST', 'SSFMCreate',
    'DISPID_SVSInputWordPosition', 'DISPID_SBSSeek', 'SASStop',
    'DISPID_SpeechCustomStream', 'DISPID_SVESentenceBoundary',
    'DISPID_SRRTTickCount', 'SVP_15', 'SVP_10', 'SRTStandard',
    'DISPID_SWFESamplesPerSec', 'SPSModifier',
    'ISpeechLexiconPronunciations', 'SpeechSpecialTransitionType',
    'SAFT16kHz8BitStereo', 'ISpeechPhraseInfoBuilder', 'SITooFast',
    'SRAORetainAudio', 'DISPID_SRGIsPronounceable',
    'DISPID_SPPsCount', 'Speech_StreamPos_RealTime', 'SP_VISEME_17',
    'ISpGrammarBuilder', 'SPEI_MIN_TTS', 'SPCS_ENABLED',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPADAPTATIONRELEVANCE',
    'SpeechRecoEvents', 'DISPID_SPEAudioStreamOffset',
    ...
    'SpeechVoicePriority', 'DISPID_SOTIsUISupported',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SVSCurrentStreamNumber',
    'SITooLoud', 'eLEXTYPE_PRIVATE20', 'SpResourceManager',
    'ISequentialStream', 'SPRST_ACTIVE', 'SPSMF_UPS',
    'SDKLCurrentUser', 'SAFTDefault', 'SAFTADPCM_22kHzMono',
    'SREPrivate', 'SpeechPropertyResponseSpeed',
    'SWPUnknownWordPronounceable', 'DISPID_SDKEnumValues',
    'DISPID_SpeechPhraseBuilder', 'SpeechVoiceSkipTypeSentence',
    'SpPhraseInfoBuilder', 'DISPID_SPANumberOfElementsInResult',
    'SAFT32kHz16BitMono', 'DISPID_SGRClear', 'DISPID_SRAudioInput',
    'SPEI_START_SR_STREAM', 'DISPID_SpeechObjectTokenCategory',
    'ISpStream', 'SECFIgnoreKanaType', 'SP_VISEME_6',
    'SSSPTRelativeToStart', 'DISPID_SPRulesCount', 'SPPS_Verb',
    'DISPID_SPEActualConfidence', 'SVP_8', 'DISPID_SPIRule',
    'SpSharedRecognizer', 'Speech_Max_Word_Length',
    'eLEXTYPE_PRIVATE8', 'SPEI_VOICE_CHANGE',
    'DISPID_SRGCmdLoadFromResource', 'SP_VISEME_7',
    'DISPID_SPRuleChildren', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SVSpeak', 'eLEXTYPE_PRIVATE13',
    'DISPID_SGRSTPropertyValue', 'SRERequestUI',
    'SpeechPropertyLowConfidenceThreshold', 'SPEI_INTERFERENCE',
    'SAFTGSM610_11kHzMono', 'SVSFIsFilename', 'eLEXTYPE_RESERVED4',
    'SAFT11kHz16BitMono', 'SVSFIsNotXML', 'SPSHT_NotOverriden',
    'SAFT16kHz16BitStereo', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRRAudioFormat', 'DISPID_SVEventInterests',
    'SPEI_SOUND_START', 'DISPID_SPRuleEngineConfidence',
    'SpeechDisplayAttributes', 'SAFT11kHz8BitMono',
    'DISPID_SPIGetText', 'DISPID_SRSetPropertyString',
    'DISPID_SRCEFalseRecognition', 'SpeechRecoProfileProperties',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SGRsAdd',
    'ISpProperties', 'DISPID_SRRecognizer', 'SDA_Two_Trailing_Spaces',
    'SAFT16kHz8BitMono', 'SGRSTTDictation', 'SAFT8kHz8BitMono',
    'ISpNotifySource', 'SAFTADPCM_44kHzMono', 'SP_VISEME_20',
    'SECFIgnoreWidth', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SDKDeleteKey', 'SpShortcut',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SOTCId',
    'SPWORDLIST', 'eLEXTYPE_PRIVATE3', 'SAFT48kHz16BitStereo',
    'SWPKnownWordPronounceable', 'SAFT24kHz16BitStereo',
    'SAFT44kHz8BitMono', 'SVSFlagsAsync', 'ISpRecoContext',
    'SPEI_SOUND_END', 'SpeechRecognizerState', 'SRAONone',
    'SP_VISEME_12', 'DISPID_SDKCreateKey', 'DISPID_SGRInitialState',
    'DISPID_SPEAudioSizeTime', 'SPSHT_Unknown', 'DISPID_SGRsCommit',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpVoice', 'SPPS_Interjection',
    'SPVISEMES', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SCSBaseStream', 'ISpeechPhraseProperties',
    'DISPID_SRCESoundEnd', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpInprocRecognizer', 'SpMMAudioIn', 'ISpeechWaveFormatEx',
    'tagSPPROPERTYINFO', 'SVP_19', 'DISPID_SOTsCount',
    'DISPID_SVEPhoneme', 'SPWF_SRENGINE',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SOTs_NewEnum',
    'SpeechPropertyResourceUsage', 'SPRS_ACTIVE', 'SVEViseme',
    'DISPID_SMSALineId', 'ISpRecognizer2', 'SpObjectToken',
    'DISPID_SBSFormat', 'SpeechEmulationCompareFlags', 'SREStreamEnd',
    'SPEI_RESERVED3', 'SPCT_SUB_COMMAND', 'DISPID_SPPConfidence',
    'SPSTREAMFORMATTYPE', 'DISPID_SRGetRecognizers',
    'SpeechGrammarState', '_SPAUDIOSTATE', 'DISPID_SGRSTPropertyId',
    'DISPID_SVDisplayUI', 'SPSLMA', 'DISPID_SpeechVoiceStatus',
    'ISpRecoResult', 'SpCompressedLexicon', 'ISpRecognizer',
    'DISPID_SFSOpen', 'DISPID_SABIMinNotification',
    'DISPID_SVAudioOutputStream', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRCERequestUI', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SpeechObjectToken', 'eLEXTYPE_PRIVATE16',
    'SpeechCategoryRecognizers', 'DISPID_SLPLangId',
    'SpeechVoiceEvents', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SVGetAudioOutputs', 'DISPID_SpeechMemoryStream',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SASCurrentDevicePosition',
    'SREInterference', 'IStream', 'SpeechPropertyAdaptationOn',
    'ISpStreamFormat', 'eWORDTYPE_DELETED', 'SPSNotOverriden',
    'DISPID_SPAPhraseInfo', 'SVEStartInputStream', 'SVP_21',
    'SPPS_Function', 'DISPID_SLPsCount', 'eWORDTYPE_ADDED',
    'DISPID_SPEs_NewEnum', 'DISPID_SPRuleParent', 'SAFTText',
    'SPEVENT', 'ISpeechPhraseInfo', 'DISPID_SpeechPhraseAlternates',
    'SpeechTokenValueCLSID', 'DISPID_SVSInputWordLength', 'SVSFIsXML',
    'SPEI_RESERVED1', 'SPINTERFERENCE_NOISE',
    'DISPID_SLAddPronunciation', 'SASClosed',
    'SpeechCategoryAppLexicons', 'STCLocalServer',
    'ISpeechPhraseReplacement', 'DISPID_SVRate', 'SPWORDTYPE',
    'SPEI_VISEME', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SVGetAudioInputs', 'SRADynamic', 'DISPID_SASState',
    'SVSFPurgeBeforeSpeak', 'SpeechPropertyNormalConfidenceThreshold'
]

_check_version('1.1.14', 1662606363.854534)
